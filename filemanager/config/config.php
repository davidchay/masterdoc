...
$base_url="http://".$_SERVER['HTTP_HOST']."/masterdoc3";  // DON'T TOUCH (base url (only domain) of site (without final /)).
//$base_url="http://localhost/masterdoc3";  // DON'T TOUCH (base url (only domain) of site (without final /)).
