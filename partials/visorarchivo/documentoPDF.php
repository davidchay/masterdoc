<?php 
    ...
    ob_start(); 
?>
<page backtop="30mm" backbottom="16mm" backleft="0mm" backright="0mm" style="font-size: 12pt" backimg="documento_obsoleto.jpg">
	<page_header>
    ...
    <bookmark title="PRESENTACIÓN" level="0" ></bookmark>
