...
$Db = new mysqli(SERVIDOR,USUARIO,CLAVE,BDATOS);
 $plantilla_completa = $Db->query("SELECT nombre_doc as nombre_documento, 
      concat(tipo_documento.codigo_doc,'-',areas.codigo_area,'-',numero_concecutivo,'-',rev) as codigo,
      concat(mes,' ',anio) AS fecha
       ...
       <table style="width:100%;border-collapse:collapse;">
         ...
         <tbody>
            ...
            for ($i=0; $i < count($borradores); $i++) { 
                ...
                echo '<td style="width:18%; text-align: center; padding:5px; border: solid 1px #c6c6c6">'.$codigo.'</td>';
...
<?php 
      ...
      $html2pdf->Output('Reporte_Aprobados.pdf'); 
?>