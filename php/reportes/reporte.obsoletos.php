...
$Db = new mysqli(SERVIDOR,USUARIO,CLAVE,BDATOS);
 $plantilla_completa = $Db->query("SELECT DISTINCT nombre_doc as nombre_documento, 
      ...
      ");
$plantilla_basica = $Db->query("SELECT DISTINCT nombre_doc as nombre_documento, 
      concat(tipo_documento.codigo_doc,'-',areas.codigo_area,'-',numero_concecutivo) as codigo,
      concat(mes,' ',anio) AS fecha
